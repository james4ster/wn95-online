    ...
    sections: [
      ...
      },
      {
        ...
        steps: [
          ...
          {
            num: '03',
            heading: 'Controller Configuration (one-time step)',
            body: (
              <>
          ...
          {
            num: '04',
            heading: 'Setup User Name (one-time step)',
            body: (
          ...
          {
            num: '05',
            heading: 'Loading Core & Content (one-time step)',
            body: (
              
                <>
                <p>The cores included with the package you downloaded are Genesis Plus GX (GPGX) for Genesis, and Snes9x for SNES. The first step 
                  we need to do is load the core. At the Main Menu, select "Load Core". Then, choose the core you would like to use 
                  (Genesis Plus GX for Genesis, Snes9x for SNES). Once you select the core, it should return you to the main menu, and you should 
                  see the core listed at the bottom of the screen.</p>
                  <img
                    src="/assets/screenshots/guide/RA-set-user-name.png"
                    alt="RetroArch User Menu"
                    className="guide-screenshot"
      ...
      },
      {
        ...
        body: (
          <>
            ...
            seconds. If games aren't connecting, this is often why.
          </>
        ),
      },
      {
        ...
        body: (
          <>
            ...
            you're running into connection issues, ask for help on the {' '}
            <span className="channel-tag">#tech-channel</span> channel on Discord. Someone will be more than willing to help.
          </>
        ),
      },
    ],
      ...
      <div className="gs-content">
        ...
        <div className="gs-help-callout">
          ...
          <div className="help-text">
            ...
            <span className="channel-tag">#tech-channel</span> channel on our Discord
