  ...
  return (
    <div className="hp">
      ...
      <a href="https://discord.gg/YOUR_INVITE" target="_blank" rel="noopener noreferrer"
        className="discord-fab" title="Discord">
      ...
      <style>{`
        *, *::before, *::after { box-sizing: border-box; }
        ...
        /* ── FIXED UI ──────────────────────────────────────── */
        .discord-fab {
          position: fixed; top: 80px; right: 1.25rem; z-index: 498;
          margin-top: 255px;
          width: 42px; height: 42px; border-radius: 50%;
          background: #5865F2; border: 2px solid rgba(255,255,255,.12);
          display: flex; align-items: center; justify-content: center;
          color: #fff; text-decoration: none;
          box-shadow: 0 4px 16px rgba(88,101,242,.4);
          transition: all .22s;
        }
        .discord-fab svg { width: 19px; height: 19px; }
        .discord-fab:hover {
